...
<body>
  ...
  <main role="main">
    ...
    <div class="container">
        ...
        <div class="row" style="background-color:#6BBA3D; height:75px; margin-top:75px;">
            <h6 style="margin: auto; broder:10px;"> Pedido realizado com Sucesso </h6>
        </div>

        <div class="row" style="margin-top:50px;">
            <div class="col-lg-4 col-md-4 sm-12" style="height:1px;"></div>
            ...
            <p class="text-center"> Veja seus pedidos na central do Usuário!
                </p>
                <!-- -->
            <?php
            if(isset($_SESSION['usuario_cpf'])) {
